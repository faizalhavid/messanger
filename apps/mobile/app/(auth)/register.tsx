...
export default function Register() {
    ...
    return (
        <AppSafeArea loading={pageState[0].isLoading} errorMessage={pageState[0].generalError}
        ...
        >
            <Stack.Screen
                options={{
                    ...
                    headerLeft: () => <Button mode="text" onPress={() => router.push('/(auth)/login')}>
                        Login
                    </Button>,

                    headerRight: () =>
                        <Button mode="text" onPress={handleRegister}
                            disabled={pageState[0].disableButtonSubmit}>Done</Button>
                }}
            />

...
import { postVerification } from '@/services/apis/auth';
    ...
    try {
      ...
      if (response.success) {
        ...
        pageState[1]({
          ...pageState[0],
          isLoading: false,
          generalError: typeof response.error === 'string' ? response.error : response.error?.message || 'Verification failed. Please try again.',
        });
      }
    } catch (error: any) {
      pageState[1]({

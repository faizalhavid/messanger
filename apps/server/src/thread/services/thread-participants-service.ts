...
import { ThreadList, ThreadModelMapper, ThreadParticipantModelMapper, ThreadParticipantPublic, threadParticipantSchema, ThreadParticipantsRequest, ThreadRequest, threadSchema, UserProfileThread } from '@messanger/types';
import { PaginatedData, PaginationMeta, QueryParamsData } from '@messanger/types';
...
export class ThreadParticipantService {
  ...
  static async getThreadParticipantsByThreadId(threadId: string, userId: string, queryParams: QueryParamsData): Promise<PaginatedData<ThreadParticipantPublic>> {
    ...
    if (search) {
      where.OR = [{ thread: { name: { contains: search, mode: 'insensitive' } } }, { user: { username: { contains: search, mode: 'insensitive' } } }];
    }
  ...
  static async addNewParticipants(req: ThreadParticipantsRequest, threadId: string, userId: string): Promise<ThreadParticipantPublic> {
  ...
  static async updateParticipant(threadId: string, userId: string, req: ThreadParticipantsRequest): Promise<ThreadParticipantPublic | null> {

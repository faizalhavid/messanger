...
import { ConversationQueryParams, FriendshipList, FriendshipModelMapper, FriendshipRequest, friendshipSchema, PaginatedData, PaginationMeta } from "@messanger/types";
...
export class FriendshipService {
    ...
    static async getFriendshipList(userId: string, queryParams: ConversationQueryParams): Promise<PaginatedData<FriendshipList>> {

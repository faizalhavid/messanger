...
import { ConversationGroupsPublic, ConversationGroupRequest, ConversationModelMapper, ConversationGroupsMessagesRequest, messageGroupsSchema, messageGroupsBaseSchema, messageSchema } from '@messanger/types';
...
export class ConversationGroupService {
  ...
  static async getMessagesGroup(groupId: string, userId: string): Promise<ConversationModelMapper[]> {
    const group = await this.conversationGroupRepository.findFirst({
      where: {
        id: groupId,
        members: {
    ...
    return messages.map((msg) =>
      ConversationModelMapper.fromConversationToConversationPublic({
        ...msg.conversation,
  ...
  static async sendMessageToGroup(req: ConversationGroupsMessagesRequest, groupId: string, userId: string): Promise<ConversationModelMapper> {
